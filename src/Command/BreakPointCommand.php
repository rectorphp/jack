...
final class BreakPointCommand extends Command
{
    ...
    protected function configure() : void
    {
        ...
        $this->addOption('ignore', null, InputOption::VALUE_IS_ARRAY | InputOption::VALUE_OPTIONAL, 'Ignore packages by name, e.g. "symfony/" or "symfony/console"');
    }
    protected function execute(InputInterface $input, OutputInterface $output) : int
    {
        ...
        $outdatedComposer = $this->outdatedComposerFactory->createOutdatedComposer(\array_filter($responseJson[ComposerKey::INSTALLED_KEY], static function (array $package) use($input) : bool {
